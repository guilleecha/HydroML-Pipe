# scripts/analisis_combinaciones.py
...
def ejecutar_analisis_completo():
    """
    Orquesta el análisis completo, generando rankings para cada k y un gráfico de trade-off.
    """
    ...
    # Crear y guardar el DataFrame resumen del trade-off
    ...
    # Detectar y visualizar el codo
    kneedle = KneeLocator(x=df_tradeoff['num_variables'], y=df_tradeoff['filas_maximas'], S=1.0, curve='convex', direction='decreasing')
    punto_optimo_k = kneedle.elbow

    # --- El código del gráfico se mantiene, pero ahora usa el estilo B&W que preferías ---
    ...
    ax1.set_xlabel('Número de Variables en la Combinación', fontsize=14)
    ax1.set_ylabel('Máximo N° de Filas de Datos Posible', fontsize=14)
